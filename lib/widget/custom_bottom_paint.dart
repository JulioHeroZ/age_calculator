...
class CustomBottomPaint extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    path_0.cubicTo(
        size.width * 0.2361111,
        size.height * 0.4475806,
        size.width * 0.05277778,
        size.height * 0.7701613,
        size.width * 0.001388889,
        size.height * 0.9979839);
    path_0.lineTo(size.width * 0.9986111, size.height * 0.9979839);
    path_0.lineTo(size.width * 0.9986111, size.height * 0.002016129);
    path_0.cubicTo(
        size.width * 0.9814806,
        size.height * 0.1586020,
        size.width * 0.8764361,
        size.height * 0.4475806,
